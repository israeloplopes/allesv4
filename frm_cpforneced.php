<?php
	...
	/////////////////////////////////////////////////
	// LISTA TODAS AS CLASSIFICAÇÕES DE Fornecedores
	/////////////////////////////////////////////////
	$conexao = conexao::getInstance();
	$qry_cptipofor = 'select * from cptipofor where codemp=:empcod order by desctipofor';
	$dts_cptipofor = $conexao->prepare($qry_cptipofor);
	$dts_cptipofor->bindvalue(':empcod',$_SESSION['codemp']);
	$dts_cptipofor->execute();
	$rs_cptipofor = $dts_cptipofor->fetchAll(PDO::FETCH_OBJ);
?>		
<!DOCTYPE html>
<html lang="pt-br">
  <head>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Insere/Edita Fornecedores</h4>
                    <p class="card-description"><small> * campos de preenchimento obrigatório <small></p>

                    <form class="forms-sample" action="pages/forms/act_vdtipocli.php" method="post" name="cpforneced" id="cpforneced" enctype="multipart/form-data" >
                      <div class="form-group">
                        <label for="exampleInputName1">Razão Social/Nome Completo *</label>
                        <input type="text" class="form-control" id="razfor" name="razfor" placeholder="Razão Social ou Nome Completo" onChange="javascript:this.value=this.value.toUpperCase();" required autofocus>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nomefor" name="nomefor" placeholder="Nome Fantasia/Apelido" onChange="javascript:this.value=this.value.toUpperCase();" required>
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Fornecedor Ativo? *</label>
						<select class="form-control" name="ativofor" id="ativofor" >
							<option value="SIM">Sim</option>
							<option value="NÃO">Não</option>
						</select>
                      </div>					  
					  <div class="form-group">
                        <label for="exampleInputName1">Tipo de Fornecedor * </label>
						<select class="form-control" name="codtipofor" id="codtipofor" >
							<?php if(!empty($rs_cptipofor)):?>
							<?php foreach($rs_cptipofor as $cptipofor):?>
								<option value="<?=$cptipofor->codtipofor;?>"><?=$cptipofor->desctipofor;?></option>
							<?php endforeach;?>	
						</select>
					  ...
					  <div class="form-group">
						...
						<select class="form-control" name="pessoafor" id="pessoafor" >
							<option value="--">--</option>
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" class="form-control" onKeyPress="MascaraCEP(cpforneced.cep);"  maxlength="9" onBlur="ValidaCEP(cpforneced.cep);" name="cepfor" id="cep" placeholder="CEP" required>
					  </div>
					  <div class="form-group">
						<label for="exampleInputEmail3">Endereço</label>
						<input type="text" class="form-control" id="endereco" name="endfor" placeholder="Endereco" onChange="javascript:this.value=this.value.toUpperCase();" required>
					  </div>
					  <div class="form-group">
						<label for="exampleInputEmail3">Número</label>
						<input type="text" class="form-control" id="numero" name="numfor" placeholder="Número" onChange="javascript:this.value=this.value.toUpperCase();" required>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" id="bairro" name="bairfor" placeholder="Bairro" onChange="javascript:this.value=this.value.toUpperCase();" required>
					  </div>	
					  <div class="form-group">
						<label for="exampleInputEmail3">Cidade</label>
						<input type="text" class="form-control" id="cidade" name="cidfor" placeholder="Cidade" onChange="javascript:this.value=this.value.toUpperCase();" required>
					  </div>
					  <div class="form-group">
						<label for="exampleInputEmail3">UF</label>
						<input type="text" class="form-control"  id="uf" name="uffor" placeholder="UF" onChange="javascript:this.value=this.value.toUpperCase();" required>
					  </div>
					  <div class="form-group">
						<label for="exampleInputEmail3">IBGE</label>
						<input type="text" class="form-control"  id="ibge" name="ibgefor" placeholder="Código Cidades IBGE" onChange="javascript:this.value=this.value.toUpperCase();" required>
					  </div>	
					  <hr>
					  <h6><i>Telefone e Contato</i></h6>
					  <div class="form-group">
                        <label for="exampleInputEmail3">Telefone</label>
                        <input type="text" class="form-control" id="fonefor" name="fonefor" placeholder="Telefone" onkeypress="return mask(event, this, '(##) ####-####')" onChange="javascript:this.value=this.value.toUpperCase();" >
						<small><span>Use para Telefone Fixo</span></small>						
                      </div>	
					  <div class="form-group">
                        <label for="exampleInputEmail3">Celular (1)</label>
                        <input type="text" class="form-control" id="celfor" name="celfor" placeholder="Celular" onkeypress="return mask(event, this, '(##)#####-####')" onChange="javascript:this.value=this.value.toUpperCase();" >
                      </div>	
					  <div class="form-group">
                        <label for="exampleInputEmail3">E-mail</label>
                        <input type="email" class="form-control" id="emailfor" name="emailfor" placeholder="E-mail" onChange="javascript:this.value=this.value.toLowerCase();" >
                      </div>			
