<?php
	...
	$qry_atatendoagenda = 'select * from atatendoagenda';
	$dts_atatendoagenda = $conexao->prepare($qry_atatendoagenda);
	$dts_atatendoagenda->execute();
	$rs_atatendoagenda = $dts_atatendoagenda->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Mensagens e Compromissos</h3>
                ...
                <div class="card">
                  <div class="card-body">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_atatendoagenda)):?>
					  <?php foreach($rs_atatendoagenda as $atatendoagenda):?>
                        <tr>
                          <td class="py-1">
							<?=$atatendoagenda->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$atatendoagenda->codmarca?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$atatendoagenda->descmarca?>
                          </td>
                          <!--<td></td>
                          <td></td>-->
                        </tr>
