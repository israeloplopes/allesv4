<?php
	...
	$qry_fnconta = 'select * from fnconta where codemp=:empcod';
	$dts_fnconta = $conexao->prepare($qry_fnconta);
	$dts_fnconta->bindvalue(':empcod',$_SESSION['codemp']);
	$dts_fnconta->execute();
	$rs_fnconta = $dts_fnconta->fetchAll(PDO::FETCH_OBJ);
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_fnconta.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_fnconta.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Contas Bancárias</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_fnconta)):?>
					  <?php foreach($rs_fnconta as $fnconta):?>
                        <tr>
                          <td class="py-1">
							<?=$fnconta->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$fnconta->numconta?></td>
                          <td>
                            <!--<div class="progress">
						  ...
						  <td><?=$fnconta->agenciaconta?></td>
						  <td><?=$fnconta->codbanco?></td>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_fnconta.php?id=<?=$fnconta->id?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_fnconta.php?id=<?=$fnconta->id?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
