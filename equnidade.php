<?php
	...
	$qry_equnidade = 'select * from equnidade where codemp=:empcod';
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
					  ...
					  <?php foreach($rs_equnidade as $equnidade):?>
                        <tr>
                          ...
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_equnidade.php?ID=<?=$equnidade->ID?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_equnidade.php?ID=<?=$equnidade->ID?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
