<?php
	...
	foreach ($rs_sgempresa as $sgempresa);
	...
	$qry_atatendente = 'select * from atatendente order by nomeatend';
...
<html lang="pt-br">
  <head>
    ...
    <title>Alles - <?=$sgempresa->nomeemp;?> - <?=$_SESSION['usuario'];?></title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Atendente</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Insere</a></li>
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Atendente</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
					  ...
					  <?php foreach($rs_atatendente as $atatendente):?>
                        <tr>
                          ...
                          <td><?=$atatendente->codmarca?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$atatendente->descmarca?>
                          </td>
                          <!--<td></td>
                          <td></td>-->
                        </tr>
