                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="pages/forms/act_eqalmox.php" method="post" name="eqalmox" id="eqalmox" enctype="multipart/form-data" >
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="codalmox" name="codalmox" placeholder="Código Almoxarifado" onChange="javascript:this.value=this.value.toUpperCase();" required autofocus>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Nome Almoxarifado *</label>
                        <input type="text" class="form-control" id="descalmox" name="descalmox" placeholder="Nome do Almoxarifado" onChange="javascript:this.value=this.value.toUpperCase();" required>
                      </div>
