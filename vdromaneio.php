<?php
	...
	$qry_vdromaneio = 'select * from vdromaneio where codemp=:empcod';
	$dts_vdromaneio = $conexao->prepare($qry_vdromaneio);
	$dts_vdromaneio->bindvalue(':empcod',$_SESSION['codemp']);
	$dts_vdromaneio->execute();
	$rs_vdromaneio = $dts_vdromaneio->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Romaneio de Carga</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_vdromaneio.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_vdromaneio.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Romaneio de Carga</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_vdromaneio)):?>
					  <?php foreach($rs_vdromaneio as $vdromaneio):?>
                        <tr>
                          <td class="py-1">
							<?=$vdromaneio->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$vdromaneio->codroma?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=date('d/m/Y', strtotime($vdromaneio->dtsaidaroma)); ?>
                          </td>
						  <td><?=date('d/m/Y', strtotime($vdromaneio->dtprevroma)); ?></td>
						  <td><?=$vdromaneio->statusroma?></td>
						  <td><?=$vdromaneio->ticket?></td>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_vdromaneio.php?ID=<?=$vdromaneio->ID?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_vdromaneio.php?ID=<?=$vdromaneio->ID?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
