<?php
	...
	$qry_lfregrafiscal = 'select * from lfregrafiscal where codemp=:empcod limit 100';
	$dts_lfregrafiscal = $conexao->prepare($qry_lfregrafiscal);
	$dts_lfregrafiscal->bindvalue(':empcod',$_SESSION['codemp']);
	$dts_lfregrafiscal->execute();
	$rs_lfregrafiscal = $dts_lfregrafiscal->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Regras Fiscais</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_lfregrafiscal.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_lfregrafiscal.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Regras Fiscais</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_lfregrafiscal)):?>
					  <?php foreach($rs_lfregrafiscal as $lfregrafiscal):?>
                        <tr>
                          <td class="py-1">
							<?=$lfregrafiscal->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$lfregrafiscal->codregra?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$lfregrafiscal->descregra?>
                          </td>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_lfregrafiscal.php?id=<?=$lfregrafiscal->id?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_lfregrafiscal.php?id=<?=$lfregrafiscal->id?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
