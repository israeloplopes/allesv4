        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Tipos de Clientes</h3>
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Insere/Edita Tipos de Clientes</h4>
                    <p class="card-description"><small> * campos de preenchimento obrigatório <small></p>

                    <form class="forms-sample" action="pages/forms/act_vdtipocli.php" method="post" name="vdtipocli" id="vdtipocli" enctype="multipart/form-data" >
                      <div class="form-group">
                        <label for="exampleInputName1">Cód. Tipo do Cliene *</label>
                        <input type="text" class="form-control" id="codtipocli" name="codtipocli" placeholder="Código Tipo de Cliente" onChange="javascript:this.value=this.value.toUpperCase();" required autofocus>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Descrição do Tipo de Cliente *</label>
                        <input type="text" class="form-control" id="desctipocli" name="desctipocli" placeholder="Descrição do Tipo de Cliente" onChange="javascript:this.value=this.value.toUpperCase();" required>
                      </div>
