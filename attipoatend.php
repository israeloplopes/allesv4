...
try{
	...
	$qry_attipoatend = 'select * from attipoatend where codemp=:empcod';
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Tipo de Atendentes</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_attipoatend.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_attipoatend.php?ID=0&amp;TP=0">Insere</a></button>
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Tipo de Atendentes</h4>
                    ...
                    <table id="hidden-table-info" class="table table-striped table-bordered">
					  ...
					  <?php foreach($rs_attipoatend as $attipoatend):?>
                        <tr>
                          ...
                          <td><?=$attipoatend->codtpatend?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$attipoatend->desctpatend?>
                          </td>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_attipoatend.php?id=<?=$attipoatend->id?>&amp;TP=1">Edita</a></button>
              <form action="pages/forms/act_attipoatend.php" class="form-horizontal style-form" name="excluir" id="excluir" method="post">
									<input type="hidden" name="acao"  value="excluir">
                  <input type="hidden" name="id"    value="<?=$attipoatend->id?>">
