<?php
	...
	$qry_sgrecado = 'select sgr.*, sge.razemp from sgrecado as sgr
					 inner join sgempresa as sge on sgr.codemp=sge.codemp ';
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Recados</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_sgrecado.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_sgrecado.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Recados</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
					  ...
					  <?php foreach($rs_sgrecado as $sgrecado):?>
                        <tr>
                          ...
                          <td><?=$sgrecado->codemp?> | <?=$sgrecado->razemp?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$sgrecado->administrativo;?>
                          </td>
						  <td><?=$sgrecado->assunto?></td>	
						  <td><?=$sgrecado->data?></td>	
						  <td><?=$sgrecado->hora?></td>							  
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_sgrecado.php?ID=<?=$sgrecado->codemp?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_sgrecado.php?ID=<?=$sgrecado->codemp?>&amp;TP=2">Bloqueia</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
