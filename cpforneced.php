<?php
	...
	$qry_cpforneced = 'select * from cpforneced where codemp=:empcod';
	$dts_cpforneced = $conexao->prepare($qry_cpforneced);
	$dts_cpforneced->bindvalue(':empcod',$_SESSION['codemp']);
	$dts_cpforneced->execute();
	$rs_cpforneced = $dts_cpforneced->fetchAll(PDO::FETCH_OBJ);
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_cpforneced.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_cpforneced.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Fornecedores</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_cpforneced)):?>
					  <?php foreach($rs_cpforneced as $cpforneced):?>
                        <tr>
                          <td class="py-1">
							<?=$cpforneced->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$cpforneced->codfor?></td>
                          <td>
                            <!--<div class="progress">
						  ...
						  <td><?=$cpforneced->nomefor?></td>
						  <td><?=$cpforneced->dddfonefor?><?=$cpforneced->fonefor?></td>
						  <td><?=$cpforneced->dddcelfor?><?=$cpforneced->celfor?></td>
						  
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_cpforneced.php?id=<?=$cpforneced->id?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_cpforneced.php?id=<?=$cpforneced->id?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
