<?php
	...
	$qry_veentrevista = 'select * from veentrevista order by COL2';
	$dts_veentrevista = $conexao->prepare($qry_veentrevista);
	$dts_veentrevista->execute();
	$rs_veentrevista = $dts_veentrevista->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Unidades</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_equnidade.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_equnidade.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Unidades</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_veentrevista)):?>
					  <?php foreach($rs_veentrevista as $veentrevista):?>
                        <tr>
                          <td class="py-1">
							<?=$veentrevista->COL2?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$veentrevista->COL5?></td>
                          <td>
                              
                              <?php
// Valor da variável
$novovalor = $veentrevista->COL5;

// URL original
$url = "https://api.whatsapp.com/send?phone=5533984602577&text=Sua%20entrevista%20de%20emprego%20para%20a%20Churrascaria%20Floresta%20est%C3%A1%20agendada%20para%20amanh%C3%A3,%20quarta-feira,%2009/08,%20a%20partir%20das%2014%20horas%20no%20Espa%C3%A7o%20Redes%20na%20Primeira%20Igreja%20Batista%20em%20Guarapari%20no%20centro.%20";

// Substituir o valor na URL
$url = preg_replace('/phone=5533984602577/', 'phone=' . $novovalor, $url);

// Imprimir a nova URL

?><a href="<?php echo $url?>">clique</a>
                            <!--<div class="progress">
                          ...
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_equnidade.php?ID=<?=$veentrevista->col1?>&amp;TP=1">Edita</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
