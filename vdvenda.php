<?php
	...
	$qry_vdvenda = 'select vd.*, vdc.nomecli, vdv.nomevend from vdvenda as vd
					inner join vdcliente as vdc on vd.codcli=vdc.codcli
					inner join vdvendedor as vdv on vd.codvend=vdv.codvend
					where vd.codemp=:empcod and vdc.codemp=vd.codemp and vdv.codemp=vd.codemp
					limit 100';
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_vdvenda.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_vdvenda.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Vendas</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
					  ...
					  <?php foreach($rs_vdvenda as $vdvenda):?>
                        <tr>
						  ...
						  <td><?=$vdvenda->docvenda?></td>
						  <td><?=date('d/m/Y', strtotime($vdvenda->dtemitvenda)); ?></td>
						  <td><?=date('d/m/Y', strtotime($vdvenda->dtsaidavenda)); ?></td>
						  <td align="right"><?=$vdvenda->vlrvenda?></td>
						  <td><?=$vdvenda->statusvenda?></td>
						  <td><?=$vdvenda->nomevend?></td>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_vdvenda.php?id=<?=$vdvenda->id?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_vdvenda.php?id=<?=$vdvenda->id?>&amp;TP=2">Exclui</a></button>
							<button type="button" class="btn btn-info btn-rounded btn-fw"><a href="frm_vdvenda.php?id=<?=$vdvenda->id?>&amp;TP=2">Fatura</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
