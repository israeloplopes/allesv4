<?php
	...
	$qry_eqgrupo = 'select * from eqgrupo where codemp=:empcod and nivelgrup=1 limit 100';
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_eqgrupo.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_eqgrupo.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Grupos</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
					  ...
					  <?php foreach($rs_eqgrupo as $eqgrupo):?>
                        <tr>
                          ...
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_eqgrupo.php?ID=<?=$eqgrupo->ID?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_eqgrupo.php?ID=<?=$eqgrupo->ID?>&amp;TP=2">Exclui</a></button>
							<button type="button" class="btn btn-info btn-rounded btn-fw"><a href="frm_eqgrupo.php?ID=<?=$eqgrupo->ID?>&amp;TP=1">Sub-Grupos</a></button>							
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
