        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Tipos de Fornecedores</h3>
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Insere/Edita Tipos de Fornecedores</h4>
                    <p class="card-description"><small> * campos de preenchimento obrigatório <small></p>

                    <form class="forms-sample" action="pages/forms/act_cptipofor.php" method="post" name="cptipofor" id="cptipofor" enctype="multipart/form-data" >
                      <div class="form-group">
                        <label for="exampleInputName1">Cód. Tipo do Fornecedor *</label>
                        <input type="text" class="form-control" id="codtipofor" name="codtipofor" placeholder="Código Tipo de Fornecedor" onChange="javascript:this.value=this.value.toUpperCase();" required autofocus>
                      </div>
                      <div class="form-group">
