<?php
	...
	$qry_lfmensagem = 'select * from lfmensagem where codemp=:empcod';
	$dts_lfmensagem = $conexao->prepare($qry_lfmensagem);
	$dts_lfmensagem->bindvalue(':empcod',$_SESSION['codemp']);
	$dts_lfmensagem->execute();
	$rs_lfmensagem = $dts_lfmensagem->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Mensagens Fiscais</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_lfmensagem.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_lfmensagem.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Mensagens Fiscais</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_lfmensagem)):?>
					  <?php foreach($rs_lfmensagem as $lfmensagem):?>
                        <tr>
                          <td class="py-1">
							<?=$lfmensagem->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$lfmensagem->codmens?></td>
                          <td>
                            <!--<div class="progress">
                          ...
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_lfmensagem.php?id=<?=$lfmensagem->id?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_lfmensagem.php?id=<?=$lfmensagem->id?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
