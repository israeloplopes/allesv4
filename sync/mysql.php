...
define('DBNAME', 'nonoelem_allesdesktop');
define('CHARSET', 'utf8');
        ...
        if (!isset(self::$pdo)) {
            try {
                ...
                switch (SGBD) :
                    ...
                    case 'mssql':{
                        if(SERVER == 'linux'):
                            self::$pdo = new \PDO("dblib:host=" . HOST . ";dbname=" . DBNAME, USER, PASSWORD, $opcoes);
                        else:
                    ...
                    case 'postgre':
                        ...
                        break;
                    case 'firebird':
                        self::$pdo = new \PDO("firebird:dbname=" . HOST . ":" . DBNAME, USER, PASSWORD);
                        break;
                endswitch;
