<?php
	...
	$qry_tai_emp_servicos = 'select tes.*, sg.razemp from tai_emp_servicos as tes
							inner join sgempresa as sg on tes.codemp=sg.codemp
							order by codacesso';
	$dts_tai_emp_servicos = $conexao->prepare($qry_tai_emp_servicos);
	$dts_tai_emp_servicos->execute();
	$rs_tai_emp_servicos = $dts_tai_emp_servicos->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Serviços contratados pelo Cliente</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_vdtipocli.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_tai_emp_servicos.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Serviços por Empresa</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_tai_emp_servicos)):?>
					  <?php foreach($rs_tai_emp_servicos as $tai_emp_servicos):?>
                        <tr>
                          <td class="py-1">
							<?=$tai_emp_servicos->codacesso?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td class="py-1">
							<?=$tai_emp_servicos->razemp?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>						  
                          <td><?=$tai_emp_servicos->servico?></td>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_vdtipocli.php?id=<?=$tai_emp_servicos->codacesso?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_vdtipocli.php?id=<?=$tai_emp_servicos->codacesso?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
