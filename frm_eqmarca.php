          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="eqmarca.php">Consulta</a></button><li>
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Insere/Edita Marcas</h4>
                    <p class="card-description"><small> * campos de preenchimento obrigatório <small></p>

                    <form class="forms-sample" action="pages/forms/act_eqmarca.php" method="post" name="eqmarca" id="eqmarca" enctype="multipart/form-data" >
                      <div class="form-group">
                        <label for="exampleInputName1">Cód. Marca *</label>
                        <input type="text" class="form-control" id="codmarca" name="codalmox" placeholder="Código Marca" onChange="javascript:this.value=this.value.toUpperCase();" required autofocus>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Nome da Marca *</label>
                        <input type="text" class="form-control" id="descmarca" name="descmarca" placeholder="Nome da Marca" onChange="javascript:this.value=this.value.toUpperCase();" required>
                      </div>
