...
try{
	...
	$qry_vdvendedor = 'select * from vdvendedor where codemp=:empcod';
	$dts_vdvendedor = $conexao->prepare($qry_vdvendedor);
	$dts_vdvendedor->bindvalue(':empcod',$_SESSION['codemp']);
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_vdvendedor.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_vdvendedor.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Vendedores</h4>
                    ...
                    <table id="hidden-table-info" class="table table-striped table-bordered">  
                      ...
                      <tbody>
                      <?php if(!empty($rs_vdvendedor)):?>
					  <?php foreach($rs_vdvendedor as $vdvendedor):?>
                        ...
                        <tr>
						  ...
						  <td><?=$vdvendedor->endvend?></td>
						  <td><?=$vdvendedor->fonevend?></td>
              <td><?=$vdvendedor->celvend?></td>              
						  <td><?=$vdvendedor->metavend?></td>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_vdvendedor.php?id=<?=$vdvendedor->id?>&amp;TP=1">Edita</a></button>
              <form action="pages/forms/act_vdvendedor.php" class="form-horizontal style-form" name="excluir" id="excluir" method="post">
									<input type="hidden" name="acao"  value="excluir">
                  <input type="hidden" name="id"    value="<?=$vdvendedor->id?>">
