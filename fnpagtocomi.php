<?php
	...
	$qry_fnpagtocomi = 'select * from fnpagtocomi';
	$dts_fnpagtocomi = $conexao->prepare($qry_fnpagtocomi);
	$dts_fnpagtocomi->execute();
	$rs_fnpagtocomi = $dts_fnpagtocomi->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Pagamento de Comissão</h3>
                ...
                <div class="card">
                  <div class="card-body">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_fnpagtocomi)):?>
					  <?php foreach($rs_fnpagtocomi as $fnpagtocomi):?>
                        <tr>
                          <td class="py-1">
							<?=$fnpagtocomi->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$fnpagtocomi->codmarca?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$fnpagtocomi->descmarca?>
                          </td>
                          <!--<td></td>
                          <td></td>-->
                        </tr>
