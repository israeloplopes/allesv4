<?php
	...
	$qry_cpordcompra = 'select * from cpordcompra';
	$dts_cpordcompra = $conexao->prepare($qry_cpordcompra);
	$dts_cpordcompra->execute();
	$rs_cpordcompra = $dts_cpordcompra->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Ordem de Compra</h3>
                ...
                <div class="card">
                  <div class="card-body">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_cpordcompra)):?>
					  <?php foreach($rs_cpordcompra as $cpordcompra):?>
                        <tr>
                          <td class="py-1">
							<?=$cpordcompra->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$cpordcompra->codmarca?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$cpordcompra->descmarca?>
                          </td>
                          <!--<td></td>
                          <td></td>-->
                        </tr>
