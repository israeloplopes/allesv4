<?php
	...
	$qry_vdreceita = 'select vdr.*, vdc.razcli from vdreceita as vdr
					  inner join vdcliente as vdc on vdr.codcliente=vdc.codcli';
	$dts_vdreceita = $conexao->prepare($qry_vdreceita);
	$dts_vdreceita->execute();
	$rs_vdreceita = $dts_vdreceita->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Receituário Agronômico</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_vdreceita.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_vdreceita.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Receituário Agronômico</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_vdreceita)):?>
					  <?php foreach($rs_vdreceita as $vdreceita):?>
                        <tr>
                          <td class="py-1">
							<?=$vdreceita->codreceita?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$vdreceita->codart?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$vdreceita->codcliente;?> | <?=$vdreceita->razcli?>
                          </td>
						  <td><?=$vdreceita->propriedade?></td>	
						  <td><?=$vdreceita->docvenda?></td>	
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_vdreceita.php?ID=<?=$vdreceita->codemp?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_vdreceita.php?ID=<?=$vdreceita->codemp?>&amp;TP=2">Bloqueia</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
