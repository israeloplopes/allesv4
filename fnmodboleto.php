<?php
	...
	$qry_fnmodboleto = 'select * from fnmodboleto where codemp=:empcod';
	$dts_fnmodboleto = $conexao->prepare($qry_fnmodboleto);
	$dts_fnmodboleto->bindvalue(':empcod',$_SESSION['codemp']);
	$dts_fnmodboleto->execute();
	$rs_fnmodboleto = $dts_fnmodboleto->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Modelo de Boletos</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_fnmodboleto.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_fnmodboleto.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Modelo de Boletos</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_fnmodboleto)):?>
					  <?php foreach($rs_fnmodboleto as $fnmodboleto):?>
                        <tr>
                          <td class="py-1">
							<?=$fnmodboleto->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$fnmodboleto->codmodbol?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$fnmodboleto->descmodbol?>
                          </td>
						  <td><?=$fnmodboleto->cartcob?></td>
						  <td><?=$fnmodboleto->numconta?></td>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_fnmodboleto.php?id=<?=$fnmodboleto->id?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_fnmodboleto.php?id=<?=$fnmodboleto->id?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
