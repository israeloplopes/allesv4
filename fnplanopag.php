<?php
	...
	$qry_fnplanopag = 'select * from fnplanopag where codemp=:empcod limit 100';
	$dts_fnplanopag = $conexao->prepare($qry_fnplanopag);
	$dts_fnplanopag->bindvalue(':empcod',$_SESSION['codemp']);
	$dts_fnplanopag->execute();
	$rs_fnplanopag = $dts_fnplanopag->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Planos de Pagamentos</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <!--<li class="breadcrumb-item"><a href="fr_fnplanopag.php" target="_self">Insere</a></li>
                  <!--<li class="breadcrumb-item active" aria-current="page">Basic tables</li>-->
				  <li class="breadcrumb-item active"><button type="button" class="btn btn-primary btn-rounded btn-fw"><a href="frm_fnplanopag.php?ID=0&amp;TP=0">Insere</a></button><li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Consulta Planos de Pagamentos</h4>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_fnplanopag)):?>
					  <?php foreach($rs_fnplanopag as $fnplanopag):?>
                        <tr>
                          <td class="py-1">
							<?=$fnplanopag->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$fnplanopag->codplanopag?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$fnplanopag->descplanopag?>
                          </td>
						  <td><?=$fnplanopag->parcplanopag?>
                          <td>
							<button type="button" class="btn btn-warning btn-rounded btn-fw"><a href="frm_fnplanopag.php?ID=<?=$fnplanopag->ID?>&amp;TP=1">Edita</a></button>
							<button type="button" class="btn btn-danger btn-rounded btn-fw"><a href="frm_fnplanopag.php?ID=<?=$fnplanopag->ID?>&amp;TP=2">Exclui</a></button>
						  </td>
                          <!--<td></td>-->
                        </tr>
                        <?php endforeach;?>	
