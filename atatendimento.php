<?php
	...
	$qry_atatendimento = 'select * from atatendimento';
	$dts_atatendimento = $conexao->prepare($qry_atatendimento);
	$dts_atatendimento->execute();
	$rs_atatendimento = $dts_atatendimento->fetchAll(PDO::FETCH_OBJ);
                ...
                <div class="card">
                  <div class="card-body">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table-responsive-sm" id="hidden-table-info">
                      ...
                      <tbody>
					  <?php if(!empty($rs_atatendimento)):?>
					  <?php foreach($rs_atatendimento as $atatendimento):?>
                        <tr>
                          <td class="py-1">
							<?=$atatendimento->id?>
                            <!--<img src="images/faces-clipart/pic-1.png" alt="image" />-->
                          </td>
                          <td><?=$atatendimento->codmarca?></td>
                          <td>
                            <!--<div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>-->
							<?=$atatendimento->descmarca?>
                          </td>
                          <!--<td></td>
                          <td></td>-->
                        </tr>
